...
9. Clique em **Salvar** e espere as alterações serem salvas.
...
5. Na tela Adicionar Página, escolha **Tabela do Dataverse** e selecione o botão **Avançar**.
...
11. No Painel de Navegação, no grupo de segurança, selecione **SubArea1**. 

12. Selecione as **Reticências** e, no menu exibido, selecione **Remover da navegação**. 

13. Selecione **Salvar** espere as alterações serem salvas. 

14. Depois de **Salvar**, selecione o botão **Publicar** para publicar as alterações. 


### <a name="task-2-test-app"></a>Tarefa nº 2: Testar app
